...
fout.write('Event,IL,CL,Alpha,Beta,m,Location,Cal_QP,Rated_QP,Peak Ratio,Cal_Vol,Rated_Vol,Volume Ratio,Cal_HP,Rec_HP,delta H,Nash-Sutcliffe, Calibn Time, Calibn Date, ,\n')
    ...
    if idx ==0:
        ...
        for p_lines in p2:
            ...
            if count > header:
                ...
                fout.write('%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s %s %s\n' %(cal_Q,rec_Q,PR,cal_V,rec_V,VR,cal_H,rec_H,dH,NS,time,day,month,year,))
